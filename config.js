...
import Workspaces from './modules/overview/onlywindows.js';
...
function toggleWindows() {
    ...
    var a = a.child;
    print(a);
    Windows[1].child.children[1].children[1].children[1].revealChild = true
}

globalThis['toggleWindows'] = toggleWindows;
